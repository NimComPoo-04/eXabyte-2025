...
const eventDetails = [
  ...
  },
  {
    ...
    modalDescription:
      "Ignite your intellect in a thrilling quiz challenge, testing knowledge and quick thinking.<br><br> <b>Participation Type:</b> Team Event (2 members - On Campus)<br><br> <b>Event Details:</b> <ul> <li>A generalized quiz covering technical topics.</li> <li>The format and rules will be announced by the Quiz Master during the event.</li> </ul>",
  ...
  },
  {
    ...
    modalDescription:
      "Dive into the competitive world of EXCELERATE! In this team based COD-Mobile tournament, players face off in matches, showcasing their skills and strategy. With standard match settings and intense gameplay, only the best will emerge victorious!<br><br> <b>Participation Type: </b> Team Event (5 members - Online Mode)<br><br><b>Event Details:</b> <br><b>The Game allowed: </b> Call of Duty mobile.<br><br> <b>Rules and Format : </b><ul><li>Each team must have 5 players.</li> <li><b>Tournament Format : </b> Knockout.</li> <li><b>Game Mode : </b>5 vs 5(Team Deathmatch, Hardpoint,Domination, Search & Destroy)</li><li><b>Time Limit : </b>8 minutes for all matches, 10 minutes for semifinals and finals.</li> <li>Verbal abuse or misconduct will result in disqualification.</li> </ul>",
  ...
  },
  {
    ...
    modalDescription:
      "Embark on the journey of DIGIBIT, where hardware circuit designing meets innovation! Dive into the realms of circuitry, solving challenges from multiple-choice prelims to hands-on finals. Efficiency and speed are the key as you bring circuit diagrams to life with provided materials.<br><br> <b>Participation Type:</b> Individual Event (On Campus)<br><br> <b>Event Details:</b><br><br> <b>Phase 1:</b> <ul> <li>MCQ questions will be provided through a Google Form.</li> <li>Qualification to the second phase will be based on the number of correctly answered questions subject to a predefined limit.</li> <li>In case of a tie, the timestamp of form submission will be considered to determine who moves on to Phase 2.</li></ul> <b>Phase 2:</b> <ul> <li>Design a circuit diagram based on the provided requirements.</li> <li>Materials will be provided.</li> <li>Scoring is based on efficiency and time taken to complete the circuit.</li> </ul>",
