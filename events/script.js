...
const eventDetails = [
  ...
  },
  {
    ...
    modalDescription:
      "Dive into the competitive world of EXCELERATE! In this solo efootball mobile tournament, players face off in 1v1 matches, showcasing their skills and strategy. With standard match settings and intense gameplay, only the best will emerge victorious!<br><br> <b>Participation Type: </b> Team Event (5 members - Online Mode)<br><br><b>Event Details:</b> <ul> <li><b>The Game allowed: </b> Call of Duty mobile.</li> <li><b>Prelims:</b> Conducted on Day 1.</li> <li><b>Finals:</b> Teams that qualify will compete on the final day.</li> <li>Teams must have a reliable internet connection for mobile gaming.</li> <li>Verbal abuse will result in disqualification.</li> </ul>",
